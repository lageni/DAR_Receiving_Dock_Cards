#!/usr/bin/env python3
"""Insert new PDF endpoint into main.py"""
import re
...
# Find the location to insert (before @app.get("/api/delivery-analysis/pdf-item"))
insert_marker = '@app.get(\"/api/delivery-analysis/pdf-item\")'
new_endpoint = '''@app.get("/api/delivery-analysis/pdf")
...
if insert_marker in content:
    ...
    with open('main.py', 'w', encoding='utf-8') as f:
        f.write(content)
    print("[SUCCESS] PDF endpoint inserted")
else:
