"""Routes: /api/delivery-analysis/pdf and /api/delivery-analysis/pdf-item."""
import time
...
from dar_app.metrics import get_avg_performance
from dar_app.pdf_export_batch import generate_batch_pdf

router = APIRouter()

@router.get("/api/delivery-analysis/pdf")
...
@router.get("/api/delivery-analysis/pdf-item")
